  ...
  <div class="wrap">
    <div class="ft-grid">
      ...
      <div class="ft-col">
        <h4>Funding</h4>
        <ul>
          <li><a href="<?php echo esc_url( home_url( '/yuushi/' ) ); ?>">融資支援</a></li>
          <li><a href="<?php echo esc_url( home_url( '/shinjigyo/' ) ); ?>">新事業進出・ものづくり商業サービス補助金</a></li>
          <li><a href="<?php echo esc_url( home_url( '/jizokuka/' ) ); ?>">持続化補助金</a></li>
          <li><a href="<?php echo esc_url( home_url( '/shorikika/' ) ); ?>">省力化投資補助金</a></li>
      ...
      <div class="ft-col">
        <h4>Web</h4>
        <ul>
          <li><a href="<?php echo esc_url( home_url( '/jikko-shien/' ) ); ?>">ホームページ制作</a></li>
          <li><a href="<?php echo esc_url( home_url( '/jikko-shien/' ) ); ?>">LP制作</a></li>
          <li><a href="<?php echo esc_url( home_url( '/jikko-shien/' ) ); ?>">SEO対策</a></li>
          <li><a href="<?php echo esc_url( home_url( '/jikko-shien/' ) ); ?>">Webマーケティング</a></li>
          <li><a href="<?php echo esc_url( home_url( '/jikko-shien/' ) ); ?>">プロダクト初期実装</a></li>
          <li><a href="<?php echo esc_url( home_url( '/jikko-shien/' ) ); ?>">AI活用・業務効率化</a></li>
        </ul>
      </div>
      <div class="ft-col">
        <h4>Company</h4>
        <ul>
          ...
          <li><a href="<?php echo esc_url( home_url( '/ceo/' ) ); ?>">代表挨拶</a></li>
          <li><a href="#">採用情報</a></li>
          <li><a href="<?php echo esc_url( home_url( '/' ) ); ?>#/agency">代理店募集</a></li>
          <li><a href="<?php echo esc_url( home_url( '/' ) ); ?>#/partner">専門家パートナー募集</a></li>
    ...
    <div class="ft-bottom">
      ...
      <div class="ft-sns"><a href="#">X</a><a href="#">Instagram</a><a href="#">YouTube</a><a href="<?php echo esc_url( salud_opt( 'line_url', '#' ) ); ?>" target="_blank" rel="noopener">LINE</a></div>
    </div>
  </div>
</footer>
...
<div class="follow-cta">
  ...
  <a class="fc-diag" href="<?php echo esc_url( home_url( '/' ) ); ?>#diag">補助金相談はこちら →</a>
</div>
...
<script>
  // 固定フロントページ以外（お問い合わせ等）にはhero要素が無いためnullガード必須
  var heroCopy = document.getElementById('heroCopy');
  if (heroCopy) { heroCopy.classList.add('on'); }
  var heroVisual = document.getElementById('heroVisual');
  if (heroVisual) { heroVisual.classList.add('on'); }
  ...
  window.addEventListener('scroll', function () {
    if (hd) { hd.classList.toggle('scrolled', window.scrollY > 60); }
    if (bar) { bar.classList.toggle('show', window.scrollY > 480); }
  }, { passive: true });

  // 簡易ページ切替（#/xxx で下層サンプルへ、#/ でTOPへ）
  // 注意: WordPressはbodyにも "page" クラスを付けるため、div.page に限定する（body.hidden化バグ防止）
  ...
  function route() {
    ...
    if (!target) { return; } // フロント以外（お問い合わせ等の固定ページ）では何もしない
