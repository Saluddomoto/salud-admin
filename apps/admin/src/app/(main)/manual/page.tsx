...
const CHANGELOG: { date: string; summary: string }[] = [
  { date: '2026-08-28', summary: '役員月報を「今月の振り返り／目標への進捗／月末会議／来月の計画」の4ブロック構成に拡張しました。年間目標（設定＞プロフィールで登録）を毎月表示しながら、進捗・課題・議論したいこと・来月の成果を整理できます。既存の行動・営業・タスク・取り組んだことの内容はそのまま保持されます。' },
