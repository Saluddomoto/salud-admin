...
const CHANGELOG: { date: string; summary: string }[] = [
  { date: '2026-08-28', summary: '役員月報に「AI分析」ボタンを追加しました。クリックすると、その月の役員全員分の月報をAIがまとめて読み、全体の要約・好調な点・共通の課題・月末会議のアジェンダ・アドバイスを生成します（結果は保存されず、押すたびにその場で生成し直します）。役員のみ利用できます。' },
