...
const CHANGELOG: { date: string; summary: string }[] = [
  ...
  { date: '2026-09-01', summary: '売上管理に「成功報酬見込み（申請済み・審査待ち）」の一覧を追加しました。審査結果待ちの案件が採択された場合にもらえる成功報酬の合計・件数・案件ごとの金額を確認できます（採択率での加重はせず満額ベースです）。' },
...
const GUIDES: { title: string; badge?: string; steps: string[] }[] = [
  ...
  },
  {
    ...
    steps: [
      ...
      '「月次実績・売上予測」タブには「成功報酬見込み（申請済み・審査待ち）」の一覧もあります。審査結果待ちの案件が採択された場合にもらえる成功報酬の合計・件数・案件ごとの金額を確認できます（採択率での加重はせず満額ベースです）。',
