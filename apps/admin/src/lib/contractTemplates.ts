...
export type ContractTemplate = {
  ...
  label: string
  description: string
  render: (input: ContractInput) => { title: string; body: string }
}
...
function partnerAgreement(input: ContractInput) {
  const dateLabel = toReiwa(input.contractDate)
  const body = `パートナー契約合意書


${input.partnerName}（以下「御社」といいます。）は、${SALUD_NAME}（以下「弊社」といいます。）に下記に掲げる条件をもって、お客様を紹介し、弊社はこれに承諾します。
...
2. お客様の補助金が採択された後、交付申請が事務局により承認された段階で、成功報酬の対象とさせていただきます。
お客様より成功報酬のお支払いが完了しましたら、その月の末日までに弊社よりチャットにてご報告いたします。
御社におかれましては、金額等をご確認のうえ、弊社宛に請求書をご発行いただきますようお願い申し上げます。
請求書が弊社に到達した後は、お客様からの成功報酬入金月の翌月末日までにお支払いさせていただきます。なお、成功報酬について、万が一お客様から返金が生じた場合には、御社は弊社に対し、該当額を速やかに返金するものとします。
...
第6条（秘密保持）
御社および弊社は、本契約の履行に関連して知り得た相手方の営業上または技術上の一切の情報について、第三者に開示または漏洩してはならないものとします。
本条の義務は、本契約終了後も有効とします。


第7条（反社会的勢力の排除）
御社および弊社は、自らまたはその役員・従業員・関係者が暴力団、暴力団関係企業、総会屋、その他これに準ずる反社会的勢力に該当しないことを保証し、かつ将来にわたってもこれに該当しないことを確約します。
万一、本条に違反する事実が判明した場合には、相手方は何らの催告なくして本契約を解除することができるものとします。


第8条（準拠法および合意管轄）
本契約の成立、効力、解釈および履行に関しては、日本法を準拠法とします。
また、本契約に起因または関連して生じる一切の紛争については、東京地方裁判所を第一審の専属的合意管轄裁判所とします。
